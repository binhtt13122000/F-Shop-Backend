...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, ApiConstant.root + "products").permitAll()
                .antMatchers("/admin/*").hasAnyAuthority(RoleConstant.ADMIN)
                .antMatchers("/seller/*").hasAuthority(RoleConstant.SELLER)
                .antMatchers("/user/*").hasAnyAuthority(RoleConstant.USER)
