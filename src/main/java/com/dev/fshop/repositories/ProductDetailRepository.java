...
public interface ProductDetailRepository extends JpaRepository<ProductDetail, String> {
    ...
    @Query("select  u from ProductDetail  u where u.product.productId = :productId and u.proSize = :productSize and u.status >= :status")
    public ProductDetail findProductDetailByProductIdAndAndProSize(String productId, String productSize, int status);
